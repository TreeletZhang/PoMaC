...
import numpy as np
from multiagent_i2c.multi_discrete import MultiDiscrete
...
class MultiAgentEnv(gym.Env):
    ...
    def __init__(self, world, reset_callback=None, reward_callback=None,
                 ...
                 done_callback=None, shared_viewer=True, discrete_action_space=False, discrete_action_input = False):
        ...
        # if true, action is a number 0...N, otherwise action is a one-hot N-dimensional vector,设置离散动作的两种表示方式
        ...
        for agent in self.agents:
            ...
            # observation space
            if len(observation_callback(agent, self.world)) == 2:
                # 返回relation graph
    ...
    def render(self, mode='human'):
        ...
        for i in range(len(self.viewers)):
            ...
            if self.viewers[i] is None:
                ...
                from multiagent_i2c import rendering
