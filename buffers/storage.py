...
class Buffer(object):  
    def __init__(self, model_parameters, obs_input_size, obs_int_input_size):  
        self.num_steps = int(model_parameters['prior_buffer_size'])  
        ...
        # treelet
        self.labels = np.zeros(self.num_steps)  
        # treelet
        self.step = 0
        self.threshold = 0
        self.percentile = model_parameters['prior_training_percentile']
        self.pos_idx = []
        self.neg_idx = []
        self.pos_t = 0
        self.neg_t = 0
    ...
    def get_threshold(self):  
        self.threshold = np.percentile(self.KL_values,
                                       self.percentile)  
    ...
    def get_samples(self, batch_size):
        ...
        return self.obs_inputs[np.array(all_samples)], self.obs_int_inputs[np.array(all_samples)], self.labels[
